...
#if !defined(_KALIBRI_TABLE_H_)
#define _KALIBRI_TABLE_H_

#include <squirrel.h>
#include <string.h>

#include "kbobject.hpp"
#include "kbfunction.hpp"
#include "kbglobalmethods.hpp"
...
public:
    ...
    ///
    /// \remarks
    /// Overloading in kalibri does not work for functions with the same amount of arguments (just like in Squirrel).
    ///
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    template<class F>
...
struct Var<Table> {
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Called by kb::PushVar to put an Table reference on the stack
    ///
    /// \param vm    Target VM
