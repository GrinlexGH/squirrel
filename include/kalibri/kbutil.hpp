...
#if !defined(_KALIBRI_UTIL_H_)
#define _KALIBRI_UTIL_H_
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
        ...
        #endif
    #endif
#elif defined(KALIBRI_IMPORT)
    #if defined(_WIN32)
        // Windows compilers need a specific keyword for import
        #define KALIBRI_API __declspec(dllimport)
    #else
        #if __GNUC__ >= 4
            // GCC 4 has special keywords for showing/hiding symbols,
            // the same keyword is used for both importing and exporting
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    #define SQCATCH(vm)          if (KALIBRI_CONST_CONDITION(false))
    #define SQCATCH_NOEXCEPT(vm) if (KALIBRI_CONST_CONDITION(false))
    #define SQCLEAR(vm)
    #define SQRETHROW(vm)
...
#elif defined (KALIBRI_USE_EXCEPTIONS)
    #define SQCATCH(vm)          } catch (const kb::Exception& e)
    #define SQCATCH_NOEXCEPT(vm) if (KALIBRI_CONST_CONDITION(false))
    #define SQCLEAR(vm)
    #ifdef _MSC_VER // avoid MSVC's "unreachable code" warning
        #define SQRETHROW(vm)      if (KALIBRI_CONST_CONDITION(true)) throw
        #define SQTHROW(vm, err)   if (KALIBRI_CONST_CONDITION(true)) throw kb::Exception(err)
    #else
        #define SQRETHROW(vm)      throw
        #define SQTHROW(vm, err)   throw kb::Exception(err)
    #endif
    #define SQTRY()              try {
...
#if !defined (KALIBRI_NO_ERROR_CHECKING) && !defined (KALIBRI_USE_EXCEPTIONS)
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// The class that must be used to deal with errors that kalibri has
///
/// \remarks
/// When documentation in kalibri says, "This function MUST have its error handled if it occurred," that
...
/// or Error::Message to clear the error buffer so new ones may occur and kalibri does not get confused.
///
/// \remarks
...
///
/// \remarks
/// If compiling with KALIBRI_USE_EXCEPTIONS defined, kalibri will throw exceptions instead of using this
/// class to handle errors. This means that functions must be enclosed in try blocks that catch
/// kb::Exception instead of checking for errors with Error::Occurred.
///
/// \remarks
/// If compiling with KALIBRI_NO_ERROR_CHECKING defined, kalibri will run significantly faster,
...
public:
    ...
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    /// Returns whether a kalibri error has occurred with a given VM
    ///
    /// \param vm Target VM
    ///
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Tells kalibri whether Squirrel error handling should be used
///
/// \remarks
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// kalibri exception class
///
/// \remarks
/// Used only when KALIBRI_USE_EXCEPTIONS is defined (see kb::Error)
///
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
class Exception {
public:
    ...
    ///
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    Exception& operator=(const Exception& ex) { message = ex.message; return *this; }
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/// Returns the last error that occurred with a Squirrel VM (not associated with kalibri errors)
///
/// \param vm Target VM
///
/// \return String containing a nice error message
