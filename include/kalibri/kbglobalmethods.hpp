//
// kbGlobalMethods: Global Methods
//
...
#if !defined(_KALIBRI_GLOBAL_METHODS_H_)
#define _KALIBRI_GLOBAL_METHODS_H_
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 1) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 2) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 3) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 4) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 5) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 6) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 7) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 8) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 9) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 10) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 11) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 12) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 13) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
...
#if !defined (KALIBRI_NO_ERROR_CHECKING)
        if (!KALIBRI_CONST_CONDITION(overloaded) && sq_gettop(vm) != startIdx + 14) {
            return sq_throwerror(vm, _SC("wrong number of parameters"));
        }
#endif
