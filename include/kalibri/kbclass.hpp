...
#if !defined(_KALIBRI_CLASS_H_)
#define _KALIBRI_CLASS_H_
...
#include "kbclasstype.hpp"
#include "kbmembermethods.hpp"
#include "kballocator.hpp"
#include "kbtypes.hpp"
...
public:
    ...
    /// See kb::Class::Prop to work around this requirement
    ///
    /// \return The Class itself so the call can be chained
    ///
    /////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
///
/// \remarks
/// Classes in Squirrel are single-inheritance only, and as such kalibri only allows for single inheritance as well.
///
/// \remarks
/// DefaultAllocator is used if no allocator is specified. This should be sufficent for most classes,
/// but if specific behavior is desired, it can be overridden. If the class should not be instantiated from
