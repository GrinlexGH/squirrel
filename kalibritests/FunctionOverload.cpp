...
TEST_F(KalibriTest, OverloadedMemberFunction) {
    DefaultVM::Set(vm);
...
TEST_F(KalibriTest, ConstOverloadTest) {
    DefaultVM::Set(vm);
...
public:
    ...
    static string sharedb;
    static int sharedIntb;
};
...
TEST_F(KalibriTest, FunctionReturningReferencesToClassesWithStaticMembers) {
    DefaultVM::Set(vm);
    ...
    .Func(_SC("set"), &B::set)
    .Func(_SC("get"), &B::get)
    .StaticVar(_SC("shared"), &B::sharedb)
    .StaticVar(_SC("sharedInt"), &B::sharedIntb);
