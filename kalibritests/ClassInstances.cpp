...
TEST_F(KalibriTest, CharPtrBindingtoString) {
...
TEST_F(KalibriTest, ClassInstances) {
    DefaultVM::Set(vm);
...
TEST_F(KalibriTest, InstanceReferencesAndStaticMembers) {
    DefaultVM::Set(vm);
...
TEST_F(KalibriTest, SimpleTypeChecking) {
    DefaultVM::Set(vm);
